...
<body>
    <nav class="navbar navbar-light bg-light border-bottom shadow-sm">
        <a class="navbar-brand d-flex" href="#">
            <h3 class="list-group-item active">BELANJA ONLINE</h3>
        </a>
    </nav>
    <div class="container-fuild d-flex">
        <form class="container mt-4 m-2 mb-2" method="POST" action="form_belanja.php">
          ...
          <div class="form-group row">
            ...
            <div class="col-4">
              <input id="number" name="jumlah_produk" placeholder="Jumlah Produk" type="number" class="form-control" required="required">
            </div>
          </div> 
          <div class="form-group row">
